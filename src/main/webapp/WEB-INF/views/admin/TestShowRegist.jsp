                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                <form:form modelAttribute="newsForm" id="userForm" enctype="multipart/form-data"
                                           class="form-horizontal form-label-left" action="${pageContext.request.contextPath}/admin/TestShow/regist/">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-6 col-md-offset-3">
                                            <a class="btn btn-primary" href="/admin/TestShow/list/" style="width: 100px;">キャンセル</a>
