                            ...
                            <div class="x_content">
                                ...
                                <div class=" col-sm-1 col-sm-1 col-xs-12">
                                    <a class="btn btn-round btn-success"
                                       href="${pageContext.request.contextPath}/admin/TestShow/regist/"
...
<script>
    ...
    function gotoUpdate(id) {
        $('#newsLoading').show();
        window.location.href = '${pageContext.request.contextPath}/admin/TestShow/edit/' + id + '/';
    }
    ...
    function gotoRegist() {
        $('#newsLoading').show();
        window.location.href =  '${pageContext.request.contextPath}/admin/TestShow/regist/';
    }
    ...
    function confirmDeleteClick() {
        ...
        $('#newsLoading').show();
        var form = $("<form></form>");
        form.attr('action', '${pageContext.request.contextPath}/admin/TestShow/delete/');
